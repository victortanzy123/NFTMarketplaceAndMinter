...
contract NiftyzoneNFTMinter is ERC1155, Ownable, ERC2981RoyaltiesPerToken {
    ...
    function overrideExistingURI(uint256 _id, string memory _uri)
        external
        onlyOwner
    {
        tokenIdToURI[_id] = _uri;
    ...
    function overrideExistingURIByContractOwner(
        uint256 _id,
    ...
    function overrideExistingURIByCreator(uint256 _id, string memory _newUri)
        external
    {
